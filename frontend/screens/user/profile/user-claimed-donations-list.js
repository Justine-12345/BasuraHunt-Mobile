...
const UserClaimedDonations = ({ navigation }) => {
    ...
    useEffect(() => {
        setItems(userClaimedItems && userClaimedItems)
    }, [userClaimedItems])
        ...
        return (
            <>
                <TouchableOpacity onPress={() =>{
                    ...
                    navigation.navigate("User", { screen: 'MyClaimed', params: { screen: 'MyPublicClaimedDonationsView', params: { item_id: item._id, category: "claimed" } } })
                }} activeOpacity={.8}>
